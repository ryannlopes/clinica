                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Cadastro Consulta</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="../../backand/insertConsulta.php">
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPassword" type="date" name="data"/>
                                            ...
                                            <div class="mt-2 mb-0">
                                                <div class="d-grid"><a href="../Tabelas/consulta.php" class="btn btn-warning btn-block" href="login.html">Voltar</a></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
